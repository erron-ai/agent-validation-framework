"""Core logic for agent_validation_framework."""
...
def analyze_records(records: list[dict[str, Any]]) -> AnalysisResult:
    ...
    return AnalysisResult(
        ...
        score=score,
        summary=f"{summary} result for: Runtime output validation for AI agents: schema checks, factual grounding, and domain constraints.",
        signals=signals,
    )
